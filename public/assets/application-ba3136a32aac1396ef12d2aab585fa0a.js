...
(function(root) {
  ...
  AsteroidsUI.initializeAbout = function() {
    if(AsteroidsUI.aboutView === undefined) {
      ...
      aboutView.$vardaracLink = aboutView.createLink("vardarac");

      aboutView.$heatedLink.addClass("outbound-link");
      aboutView.$vardaracLink.addClass("outbound-link");
      ...
      aboutView.linkHandlers = function() {
        ...
        aboutView.$vardaracLink.click(function() {
    ...
    AsteroidsUI.swapView(AsteroidsUI.aboutView, [
      ...
      function() {
        window.setTimeout(function() {
          ...
          AsteroidsUI.aboutView.$vardaracLink.css({
            opacity: 1
          });
        }, 500);
        window.setTimeout(function() {
  ...
  if ($gameContainer.attr("id") !== undefined) {
    AsteroidsUI.imagesHash = {
      ...
      $loadingTextImg: jQuery("<img/>", {
        ...
        src: "https://s3-us-west-2.amazonaws.com/vardarac-asteroids-main/loading-image.png"
      }),

      // menu view
      $mainMenuImg: jQuery("<img/>", {
        class: "main-menu-image",
        src: "https://s3-us-west-2.amazonaws.com/vardarac-asteroids-main/asteroids-main-menu.png"
      }),

      // about view
      $aboutImg: jQuery("<img/>",{
        class: "about-image",
        src: "https://s3-us-west-2.amazonaws.com/vardarac-asteroids-main/asteroids-about-image.png"
      }),

      // help view
      $helpImg: jQuery("<img/>",{
        class: "help-image",
        src: "https://s3-us-west-2.amazonaws.com/vardarac-asteroids-main/asteroids-help-image.png"
      }),

      // high scores view
      $highScoresImg: jQuery("<img/>",{
        class: "high-scores-image",
        src: "https://s3-us-west-2.amazonaws.com/vardarac-asteroids-main/asteroids-high-scores.png"
      }),

      // game view
      $getReadyImg: jQuery("<img/>",{
        class: "get-ready-image",
        src: "https://s3-us-west-2.amazonaws.com/vardarac-asteroids-main/get-ready.png"
      }),

      $gameOverImg: jQuery("<img/>",{
        class: "game-over-image",
        src: "https://s3-us-west-2.amazonaws.com/vardarac-asteroids-main/game-over.png"
      }),

      $youWinImg: jQuery("<img/>",{
        class: "you-win-image",
        src: "https://s3-us-west-2.amazonaws.com/vardarac-asteroids-main/you-win.png"
      })
    };
    ...
    soundManager.setup({
      ...
      onready: function() {
        ...
        soundManager.createSound({
          id: "explode1",
          url: "https://s3-us-west-2.amazonaws.com/vardarac-asteroids-main/explode1.wav",
          autoLoad: true,
          autoPlay: false,
          stream: false,
          onload: function() {
        ...
        soundManager.createSound({
          id: "life",
          url: "https://s3-us-west-2.amazonaws.com/vardarac-asteroids-main/life.wav",
          autoLoad: true,
          autoPlay: false,
          stream: false,
          onload: function() {
        ...
        soundManager.createSound({
          id: "explode2",
          url: "https://s3-us-west-2.amazonaws.com/vardarac-asteroids-main/explode2.wav",
          autoLoad: true,
          autoPlay: false,
          stream: false,
          onload: function() {
        ...
        soundManager.createSound({
          id: "explode3",
          url: "https://s3-us-west-2.amazonaws.com/vardarac-asteroids-main/explode3.wav",
          autoLoad: true,
          autoPlay: false,
          stream: false,
          onload: function() {
        ...
        soundManager.createSound({
          id: "fire",
          url: "https://s3-us-west-2.amazonaws.com/vardarac-asteroids-main/fire.wav",
          autoLoad: true,
          autoPlay: false,
          stream: false,
          onload: function() {
        ...
        soundManager.createSound({
          id: "thrust",
          url: "https://s3-us-west-2.amazonaws.com/vardarac-asteroids-main/thrust.wav",
          autoLoad: true,
          autoPlay: false,
          stream: false,
          onload: function() {
