...
var ready = function() {
  if(window.isStaticPage) {
    ...
    $("body").css({
      ...
      "background": "https://s3-us-west-1.amazonaws.com/vardarac-common/portfolio-images/background.jpg no-repeat center center fixed",
...
(function(root) {
  ...
  AsteroidsUI.s3AmazonBucket = "https://s3-us-west-2.amazonaws.com/vardarac-asteroids-main/"
  AsteroidsUI.highScoresHost = "http://vardarac-portfolio.herokuapp.com/scores/"
